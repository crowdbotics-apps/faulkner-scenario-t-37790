...
## Project Structure
    ...
    ├── faulkner_scenario_t_37790  # Django project configurations
...
1. Clone this repo and `cd faulkner_scenario_t_37790`
...
2. Clone this repo and `cd faulkner_scenario_t_37790`
